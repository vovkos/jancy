...
getTypeModifierString(TypeModifier modifier) {
	static const char* stringTable[] = {
		...
		"const?",       // TypeModifier_MaybeConst = 0x00000008,
		"constif",      // TypeModifier_ConstIf    = 0x00000010,
		"readonly",     // TypeModifier_ReadOnly   = 0x00000020,
		"volatile",     // TypeModifier_Volatile   = 0x00000040,
		"weak",         // TypeModifier_Weak       = 0x00000080,
		"thin",         // TypeModifier_Thin       = 0x00000100,
		"safe",         // TypeModifier_Safe       = 0x00000200,
		"cdecl",        // TypeModifier_Cdecl      = 0x00000400,
		"stdcall",      // TypeModifier_Stdcall    = 0x00000800,
		"array",        // TypeModifier_Array      = 0x00001000,
		"function",     // TypeModifier_Function   = 0x00002000,
		"property",     // TypeModifier_Property   = 0x00004000,
		"bindable",     // TypeModifier_Bindable   = 0x00008000,
		"autoget",      // TypeModifier_AutoGet    = 0x00010000,
		"indexed",      // TypeModifier_Indexed    = 0x00020000,
		"multicast",    // TypeModifier_Multicast  = 0x00040000,
		"event",        // TypeModifier_Event      = 0x00080000,
		"<unused>",     // TypeModifier_Unused     = 0x00100000,
		"reactor",      // TypeModifier_Reactor    = 0x00200000,
		"thiscall",     // TypeModifier_Thiscall   = 0x00400000,
		"jnccall",      // TypeModifier_Jnccall    = 0x00800000,
		"unsafe",       // TypeModifier_Unsafe     = 0x01000000,
		"errorcode",    // TypeModifier_ErrorCode  = 0x02000000,
		"async",        // TypeModifier_Async      = 0x04000000,
	};
...
TypeModifiers::addTypeModifier(TypeModifier modifier) {
	...
	antiModifierTable[] = {
		...
		TypeModifierMaskKind_Const,     // TypeModifier_ConstIf    = 0x00000010,
		TypeModifierMaskKind_Const,     // TypeModifier_ReadOnly   = 0x00000020,
		0,                              // TypeModifier_Volatile   = 0x00000040,
		TypeModifierMaskKind_PtrKind,   // TypeModifier_Weak       = 0x00000080,
		TypeModifierMaskKind_PtrKind,   // TypeModifier_Thin       = 0x00000100,
		TypeModifier_Unsafe,            // TypeModifier_Safe       = 0x00000200,
		TypeModifierMaskKind_CallConv,  // TypeModifier_Cdecl      = 0x00000400,
		TypeModifierMaskKind_CallConv,  // TypeModifier_Stdcall    = 0x00000800,
		TypeModifierMaskKind_TypeKind,  // TypeModifier_Array      = 0x00001000,
		TypeModifierMaskKind_TypeKind & // TypeModifier_Function   = 0x00002000,
			~TypeModifier_Function,
		TypeModifierMaskKind_TypeKind,  // TypeModifier_Property   = 0x00004000,
		0,                              // TypeModifier_Bindable   = 0x00008000,
		TypeModifier_Indexed,           // TypeModifier_AutoGet    = 0x00010000,
