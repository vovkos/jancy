...
void
AXL_CDECL
Recognizer::construct (rt::FunctionPtr automatonFuncPtr)
{
...
void
AXL_CDECL
Recognizer::setAutomatonFunc (rt::FunctionPtr automatonFuncPtr)
{
...
Recognizer::setLexemeLengthLimit (size_t length)
{
	...
	rt::DataPtr ptr = runtime->m_gcHeap.allocateBuffer (m_lexemeLengthLimit);
	if (m_lexemeLength)
