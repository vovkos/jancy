...
DataPtr
FmtLiteralLib::dynamicCastDataPtr (
	DataPtr ptr,
	Type* type
	)
{
...
IfaceHdr*
FmtLiteralLib::dynamicCastClassPtr (
	IfaceHdr* iface,
	ClassType* type
	)
{
...
bool
FmtLiteralLib::dynamicCastVariant (
	Variant variant,
	Type* type,
	void* buffer
	)
...
IfaceHdr*
FmtLiteralLib::strengthenClassPtr (IfaceHdr* iface)
{
	if (!iface)
		return NULL;
...
void
FmtLiteralLib::primeStaticClass (
	Box* box,
	ClassType* type
	)
{
...
IfaceHdr*
FmtLiteralLib::tryAllocateClass (ClassType* type)
{
...
IfaceHdr*
FmtLiteralLib::allocateClass (ClassType* type)
{
	Runtime* runtime = getCurrentThreadRuntime ();
	ASSERT (runtime);
...
DataPtr
FmtLiteralLib::tryAllocateData (Type* type)
{
	Runtime* runtime = getCurrentThreadRuntime ();
	ASSERT (runtime);
...
DataPtr
FmtLiteralLib::allocateData (Type* type)
{
	Runtime* runtime = getCurrentThreadRuntime ();
	ASSERT (runtime);
...
DataPtr
FmtLiteralLib::tryAllocateArray (
	Type* type,
	size_t elementCount
	)
{
...
DataPtrValidator* 
FmtLiteralLib::createDataPtrValidator (
	Box* box,
	void* rangeBegin,
	size_t rangeLength
	)
...
size_t
FmtLiteralLib::strLen (DataPtr ptr)
{
...
void
FmtLiteralLib::sleep (uint32_t msCount)
{
	Runtime* runtime = getCurrentThreadRuntime ();
	ASSERT (runtime);
...
DWORD
WINAPI
FmtLiteralLib::threadFunc (PVOID context0)
{
...
bool
FmtLiteralLib::createThread (FunctionPtr ptr)
{
	Runtime* runtime = getCurrentThreadRuntime ();
	ASSERT (runtime);
	...
	DWORD threadId;
	HANDLE h = ::CreateThread (NULL, 0, FmtLiteralLib::threadFunc, &context, 0, &threadId);
...
void*
FmtLiteralLib::threadFunc (void* context0)
{
	ThreadContext* context = (ThreadContext*) context0;
	ASSERT (context && context->m_runtime && context->m_ptr.m_p);
	FunctionPtr ptr = context->m_ptr;
...
FmtLiteralLib::createThread (FunctionPtr ptr)
{
	...
	pthread_t thread;
	int result = pthread_create (&thread, NULL, FmtLiteralLib::threadFunc, &context);
...
DataPtr
FmtLiteralLib::getErrorPtr (const err::ErrorData* errorData)
{
...
void
FmtLiteralLib::assertionFailure (
	const char* fileName,
	int line,
...
void
FmtLiteralLib::addStaticDestructor (StaticDestructFunc* destructFunc)
{
	Runtime* runtime = getCurrentThreadRuntime ();
	ASSERT (runtime);
...
void
FmtLiteralLib::addStaticClassDestructor (
...
size_t
FmtLiteralLib::appendFmtLiteral_a (
...
void
FmtLiteralLib::prepareFormatString (
...
size_t
FmtLiteralLib::appendFmtLiteral_v (
	FmtLiteral* fmtLiteral,
	const char* fmtSpecifier,
	Variant variant
	)
...
size_t
FmtLiteralLib::appendFmtLiteralImpl (
	FmtLiteral* fmtLiteral,
	const char* fmtSpecifier,
	const char* defaultType,
	...
...
size_t
FmtLiteralLib::appendFmtLiteralStringImpl (
	FmtLiteral* fmtLiteral,
	const char* fmtSpecifier,
	const char* p,
	size_t length
...
bool 
FmtLiteralLib::tryCheckDataPtrRangeDirect (
	const void* p,
...
void 
FmtLiteralLib::checkDataPtrRangeDirect (
	const void* p,
	const void* rangeBegin,
	size_t rangeLength
	)
...
bool 
FmtLiteralLib::tryCheckDataPtrRangeIndirect (
	const void* p,
	size_t size,
...
void 
FmtLiteralLib::checkDataPtrRangeIndirect (
	const void* p,
	size_t size,
	DataPtrValidator* validator
	)
...
void
FmtLiteralLib::checkStackOverflow ()
{
	Runtime* runtime = getCurrentThreadRuntime ();
	ASSERT (runtime);
...
void* 
FmtLiteralLib::tryLazyGetLibraryFunction (
	Library* library,
	size_t index,
	const char* name
	)
...
void* 
FmtLiteralLib::lazyGetLibraryFunction (
	Library* library,
	size_t index,
	const char* name
	)
