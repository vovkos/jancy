...
class Recognizer: public rt::IfaceHdr
{
public:
...
public:
	rt::FunctionPtr m_automatonFuncPtr;
	size_t m_lexemeLengthLimit;
	size_t m_currentOffset;

	rt::DataPtr m_lexemePtr;
...
public:
	void
	AXL_CDECL
	construct (rt::FunctionPtr automatonFuncPtr);

	void
	AXL_CDECL
	setAutomatonFunc (rt::FunctionPtr automatonFuncPtr);
