...
JNC_BEGIN_LIB_FUNCTION_MAP(jnc_StdLib)
	...
	JNC_MAP_FUNCTION("isspace", enc::isSpace)
	JNC_MAP_FUNCTION("isprint", enc::isPrintable)
	JNC_MAP_FUNCTION("ispunct", enc::isPunctuation)
	JNC_MAP_FUNCTION("isalpha", enc::isLetter)
	JNC_MAP_FUNCTION("isalnum", enc::isLetterOrDigit)
	JNC_MAP_FUNCTION("isdigit", enc::isDigit)
