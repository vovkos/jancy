...
JNC_BEGIN_TYPE_FUNCTION_MAP(SshChannel)
	...
	JNC_MAP_PROPERTY("m_keepAliveIdleTimeout", &SshChannel::getKeepAliveIdleTimeout, &SshChannel::setKeepAliveIdleTimeout)
	JNC_MAP_PROPERTY("m_keepAliveRetryInterval", &SshChannel::getKeepAliveRetryInterval, &SshChannel::setKeepAliveRetryInterval)
