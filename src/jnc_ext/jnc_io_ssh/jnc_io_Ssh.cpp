...
JNC_BEGIN_TYPE_FUNCTION_MAP(SshChannel)
	...
	JNC_MAP_PROPERTY("m_tcpKeepAliveIdleTimeout", &SshChannel::getTcpKeepAliveIdleTimeout, &SshChannel::setTcpKeepAliveIdleTimeout)
	JNC_MAP_PROPERTY("m_tcpKeepAliveRetryInterval", &SshChannel::getTcpKeepAliveRetryInterval, &SshChannel::setTcpKeepAliveRetryInterval)
