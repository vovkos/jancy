...
JNC_BEGIN_TYPE_FUNCTION_MAP(SslSocket)
	...
	JNC_MAP_PROPERTY("m_tcpKeepAliveIdleTimeout", &SslSocket::getTcpKeepAliveIdleTimeout, &SslSocket::setTcpKeepAliveIdleTimeout)
	JNC_MAP_PROPERTY("m_tcpKeepAliveRetryInterval", &SslSocket::getTcpKeepAliveRetryInterval, &SslSocket::setTcpKeepAliveRetryInterval)
