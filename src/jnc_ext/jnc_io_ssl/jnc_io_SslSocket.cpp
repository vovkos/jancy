...
JNC_BEGIN_TYPE_FUNCTION_MAP(SslSocket)
	...
	JNC_MAP_PROPERTY("m_keepAliveIdleTimeout", &SslSocket::getKeepAliveIdleTimeout, &SslSocket::setKeepAliveIdleTimeout)
	JNC_MAP_PROPERTY("m_keepAliveRetryInterval", &SslSocket::getKeepAliveRetryInterval, &SslSocket::setKeepAliveRetryInterval)
