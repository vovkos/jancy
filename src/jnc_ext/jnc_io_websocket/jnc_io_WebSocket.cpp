...
JNC_BEGIN_TYPE_FUNCTION_MAP(WebSocket)
	...
	JNC_MAP_PROPERTY("m_tcpKeepAliveIdleTimeout", &WebSocket::getTcpKeepAliveIdleTimeout, &WebSocket::setTcpKeepAliveIdleTimeout)
	JNC_MAP_PROPERTY("m_tcpKeepAliveRetryInterval", &WebSocket::getTcpKeepAliveRetryInterval, &WebSocket::setTcpKeepAliveRetryInterval)
