...
#endif
	JNC_MAP_FUNCTION_Q("io.enumerateNetworkAdapters", enumerateNetworkAdapters)
	JNC_MAP_FUNCTION_Q("io.enumerateSerialPorts", enumerateSerialPorts)
	JNC_MAP_FUNCTION_Q("io.getSymbolicLinkTarget", getSymbolicLinkTarget)
	JNC_MAP_FUNCTION_Q("io.getHomeDir", getHomeDir)
	JNC_MAP_FUNCTION_Q("io.getTempDir", getTempDir)
	JNC_MAP_FUNCTION_Q("io.createTempFile", createTempFile)
	JNC_MAP_FUNCTION_Q("io.renameFile", renameFile)
	JNC_MAP_FUNCTION_Q("io.deleteFile", deleteFile)
