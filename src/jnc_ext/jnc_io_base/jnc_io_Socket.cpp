...
JNC_BEGIN_TYPE_FUNCTION_MAP(Socket)
	...
	JNC_MAP_PROPERTY("m_keepAliveIdleTimeout", &Socket::getKeepAliveIdleTimeout, &Socket::setKeepAliveIdleTimeout)
	JNC_MAP_PROPERTY("m_keepAliveRetryInterval", &Socket::getKeepAliveRetryInterval, &Socket::setKeepAliveRetryInterval)
