...
typedef jnc::ct::Template jnc_Template;
...
typedef jnc::ct::Field jnc_Field;
...
typedef jnc::ct::FunctionTypeOverload jnc_FunctionTypeOverload;
...
typedef jnc::ct::TemplateArgType jnc_TemplateArgType;
...
typedef struct jnc_Template jnc_Template;
...
typedef struct jnc_Field jnc_Field;
...
typedef struct jnc_FunctionTypeOverload jnc_FunctionTypeOverload;
...
typedef struct jnc_TemplateArgType jnc_TemplateArgType;
...
typedef jnc_FunctionTypeOverload FunctionTypeOverload;
...
typedef jnc_TemplateArgType TemplateArgType;
