...
typedef jnc::ct::DynamicStructType jnc_DynamicStructType;
...
typedef struct jnc_DynamicStructType jnc_DynamicStructType;
...
typedef jnc_DynamicStructType DynamicStructType;
