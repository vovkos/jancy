...
JNC_BEGIN_LIB_FUNCTION_MAP(TestLib)
	JNC_MAP_FUNCTION_Q("jnc2c.funcInt32",     &jnc2c::funcInt32)
	JNC_MAP_FUNCTION_Q("jnc2c.funcInt64",     &jnc2c::funcInt64)
	JNC_MAP_FUNCTION_Q("jnc2c.funcStruct32",  &jnc2c::funcStruct32)
	JNC_MAP_FUNCTION_Q("jnc2c.funcStruct64",  &jnc2c::funcStruct64)
	JNC_MAP_FUNCTION_Q("jnc2c.funcStruct128", &jnc2c::funcStruct128)
	JNC_MAP_FUNCTION_Q("jnc2c.funcVariant",   &jnc2c::funcVariant)
	JNC_MAP_FUNCTION_Q("jnc2c.funcPtr",       &jnc2c::funcPtr)
	JNC_MAP_FUNCTION_Q("jnc2c.funcFloat",     &jnc2c::funcFloat)
	JNC_MAP_FUNCTION_Q("jnc2c.funcDouble",    &jnc2c::funcDouble)
